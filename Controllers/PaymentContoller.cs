...
{
    [Route("[controller]/")]
    public class PaymentContoller : Controller
    {
        private readonly ILogger<PaymentContoller> _logger;
        private readonly IHubContext<PayHub> _hubContext;
        private readonly productDb _context;

        public PaymentContoller(ILogger<PaymentContoller> logger, IHubContext<PayHub> hubContext, productDb context)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Pay([FromBody] PaymentRequestDTO req)
        {
           var order = _context.Orders.FirstOrDefault(o => o.Id.ToString() == req.TransactionId);
            ...
            CreatePaymentRequest request = new CreatePaymentRequest
            {
                ...
                CallbackUrl = "http://localhost:5039/PaymentContoller/pay-callback"
            };
